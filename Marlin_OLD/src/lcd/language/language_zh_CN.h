...
namespace LanguageNarrow_zh_CN {
  ...
  PROGMEM Language_Str MSG_HOMING                         = _UxGT("回原点");
  ...
  PROGMEM Language_Str MSG_LEVEL_BED_HOMING               = _UxGT("热床XYZ归位"); // "Homing XYZ"
  ...
  PROGMEM Language_Str MSG_PREHEAT_2_SETTINGS             = _UxGT("预热 ") PREHEAT_2_LABEL _UxGT("热床"); //MSG_PREHEAT_2 " conf"
  ...
  PROGMEM Language_Str MSG_SWITCH_PS_ON                   = _UxGT("开启电源"); // "Switch power on"
  PROGMEM Language_Str MSG_SWITCH_PS_OFF                  = _UxGT("关闭电源"); // "Switch power off"
  ...
  PROGMEM Language_Str MSG_LEVEL_CORNERS                  = _UxGT("调平边角"); // "Bed Tramming"
  ...
  PROGMEM Language_Str MSG_HOTEND_OFFSET_A                = _UxGT("第二喷头是@");
  ...
  PROGMEM Language_Str MSG_UBL_BUILD_MESH_M2              = _UxGT("创设 ") PREHEAT_2_LABEL _UxGT("网格"); // "Build PREHEAT_1_LABEL Mesh"
  PROGMEM Language_Str MSG_UBL_VALIDATE_MESH_MENU         = _UxGT("批准网格");  // "VALIDATE MESH"
  PROGMEM Language_Str MSG_UBL_VALIDATE_MESH_M1           = _UxGT("批准 ") PREHEAT_1_LABEL _UxGT("网格");
  PROGMEM Language_Str MSG_UBL_VALIDATE_MESH_M2           = _UxGT("批准") PREHEAT_2_LABEL _UxGT("网格");
  ...
  PROGMEM Language_Str MSG_MOVE_N                         = _UxGT("移动@"); // "Move @"
  ...
  PROGMEM Language_Str MSG_PID_BAD_HEATER_ID              = _UxGT("自动调失败! 坏的挤出机");
  ...
  PROGMEM Language_Str MSG_VA_JERK                        = _UxGT("轴抖动速率") STR_A; // "Va-jerk"
  PROGMEM Language_Str MSG_VB_JERK                        = _UxGT("轴抖动速率") STR_B; // "Vb-jerk"
  PROGMEM Language_Str MSG_VC_JERK                        = _UxGT("轴抖动速率") STR_C; // "Vc-jerk"
  PROGMEM Language_Str MSG_VN_JERK                        = _UxGT("轴抖动速率@"); // "V@-jerk"
  ...
  PROGMEM Language_Str MSG_VMAX_A                         = _UxGT("最大进料速率") STR_A; // "Vmax " max_feedrate_mm_s
  PROGMEM Language_Str MSG_VMAX_B                         = _UxGT("最大进料速率") STR_B;
  PROGMEM Language_Str MSG_VMAX_C                         = _UxGT("最大进料速率") STR_C;
  PROGMEM Language_Str MSG_VMAX_N                         = _UxGT("最大进料速率@");
  PROGMEM Language_Str MSG_VMAX_E                         = _UxGT("最大进料速率E");
  ...
  PROGMEM Language_Str MSG_AMAX_A                         = _UxGT("最大打印加速度") STR_A; // "Amax " max_acceleration_mm_per_s2, acceleration in units/s^2 for print moves
  PROGMEM Language_Str MSG_AMAX_B                         = _UxGT("最大打印加速度") STR_B;
  PROGMEM Language_Str MSG_AMAX_C                         = _UxGT("最大打印加速度") STR_C;
  PROGMEM Language_Str MSG_AMAX_N                         = _UxGT("最大打印加速度@");
  PROGMEM Language_Str MSG_AMAX_E                         = _UxGT("最大打印加速度E");
  ...
  PROGMEM Language_Str MSG_A_STEPS                        = STR_A _UxGT(" 步数/mm"); // "Asteps/mm"
  PROGMEM Language_Str MSG_B_STEPS                        = STR_B _UxGT(" 步数/mm");
  PROGMEM Language_Str MSG_C_STEPS                        = STR_C _UxGT(" 步数/mm");
  PROGMEM Language_Str MSG_N_STEPS                        = _UxGT("@ 步数/mm");
  ...
  PROGMEM Language_Str MSG_ERR_EEPROM_CRC                 = _UxGT("EEPROM 校验和 错误");
  PROGMEM Language_Str MSG_ERR_EEPROM_SIZE                = _UxGT("EEPROM 尺寸 错误");
  PROGMEM Language_Str MSG_ERR_EEPROM_VERSION             = _UxGT("EEPROM 版本 错误");
  ...
  PROGMEM Language_Str MSG_HOME_FIRST                     = _UxGT("归位 %s 先"); // "Home ... first"
  ...
  PROGMEM Language_Str MSG_ERR_HEATING_FAILED             = _UxGT("加热失败"); // "Heating failed"
  PROGMEM Language_Str MSG_ERR_REDUNDANT_TEMP             = _UxGT("错误：冗余温度"); // "Err: REDUNDANT TEMP"
  PROGMEM Language_Str MSG_ERR_THERMAL_RUNAWAY            = _UxGT("温控失控"); // "THERMAL RUNAWAY"
  ...
  PROGMEM Language_Str MSG_ERR_MAXTEMP_BED                = _UxGT("错误: 床温过高");
  PROGMEM Language_Str MSG_ERR_MINTEMP_BED                = _UxGT("错误: 床温过低");
  PROGMEM Language_Str MSG_ERR_MAXTEMP_CHAMBER            = _UxGT("错误: 室温过高");
  PROGMEM Language_Str MSG_ERR_MINTEMP_CHAMBER            = _UxGT("错误: 室温过低");
  ...
  PROGMEM Language_Str MSG_DAC_PERCENT_N                  = _UxGT("@ 驱动 %"); // "E Driver %"
