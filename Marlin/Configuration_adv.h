...
#define SHOW_TEMP_ADC_VALUES // DaHai - Enabled so you can calibrate the Thermisor, if necessary
...
//
//#define JUNCTION_DEVIATION // DaHai - Want to enable this later...
 ...
 */
#define ADAPTIVE_STEP_SMOOTHING // DaHai - Enabled, why not?
...
#define LCD_INFO_MENU // DaHai - Enabled (lets see what this does)
...
//#define LED_CONTROL_MENU
 ...
 // #if ENABLED(POWER_LOSS_RECOVERY)
   // #define POWER_LOSS_PIN   15     // Pin to detect power loss
 ...
 */
#define BABYSTEPPING  // DaHai - Enabled
#if ENABLED(BABYSTEPPING)
  //#define BABYSTEP_XY              // Also enable X/Y Babystepping. Not supported on DELTA!
  #define BABYSTEP_INVERT_Z false    // Change if Z babysteps should go the other way
  #define BABYSTEP_MULTIPLICATOR 1   // Babysteps are very small. Increase for faster motion.
  //#define BABYSTEP_ZPROBE_OFFSET   // Enable to combine M851 and Babystepping
  #define DOUBLECLICK_FOR_Z_BABYSTEPPING // Double-click on the Status Screen for Z Babystepping. // DaHai - enabled
...
#define ADVANCED_PAUSE_FEATURE
  ...
  #define PARK_HEAD_ON_PAUSE                    // Park the nozzle during pause and filament change. // DaHai - enabled, otherwise it just poops on the print
  //#define HOME_BEFORE_FILAMENT_CHANGE           // Ensure homing has been completed prior to parking for filament change

  #define FILAMENT_LOAD_UNLOAD_GCODES           // Add M701/M702 Load/Unload G-codes, plus Load/Unload in the LCD Prepare menu. // DaHai - enabled
